...
boundary = -5            # define the boundary for the simple model, this is not used in the complex model
suffix = '75m'           # output file suffix  
depth = 75               # define the sensor depth       
